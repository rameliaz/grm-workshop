...
::: {.lead}
In CTT terms, every increase in the latent trait (i.e., "Depression") is associated with a constant increase in the expected score on the item. In other words, the latent trait **causes** the observed score.
:::
...
| [SRMSR](https://psycnet.apa.org/record/2014-30220-001) | ≤ .05 | .05–.08 = acceptable; \< .08 = some misfit, but not severe |
...
* At the **item level**, `itemfit()` gives us $S\_X^2$ and its corresponding *p*-value.
