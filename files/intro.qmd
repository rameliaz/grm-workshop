...
* **$a$ (discrimination):** *how strongly* it distinguishes people around that point. Larger discrimination parameters means steeper probability curves, which reflect more informative item.
* Rule of thumbs ([Baker & Kim, 2017](https://link.springer.com/book/10.1007/978-3-319-54205-8)): 
  + $a$ less than 0.35 = very low
  + 0.35 – 0.64 = low
  + 0.65 – 1.34 = moderate
  + 1.35 – 1.69 = high
  + 1.70 or more = very high
:::
...
In addition to the examples shown above, there are many other IRT variants that are specifically calibrated to estimate models with *n* dimensions, *n* response categories, response formats and response styles.
:::
