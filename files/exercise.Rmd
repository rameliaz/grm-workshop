...
This is the hands-on companion to *"Introduction to IRT's Graded Response Model"* (Workshop Itemkonstruktion, Uni Duisburg-Essen, 28.–29. September 2026). It mirrors the workflow from the tutorial paper this workshop is based on: [Zein & Akhtar (2025), *Getting started with the graded response model: An introduction and tutorial in R*](https://onlinelibrary.wiley.com/doi/abs/10.1002/ijop.13265), but on a different dataset.
